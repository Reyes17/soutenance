...
<head>
  ...
  <title>Ajouter auteur secondaire</title>
        ...
        <ul id="ouvrages-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="../ouvrage/liste_des_ouvrages.php">
              <i class="bi bi-circle"></i><span>Listes des ouvrages</span>
            </a>
          </li>
          <li>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md-6 text-end cefp-list-add-btn">
              <a href="liste_des_auteurs_secondaires.php" class="btn btn-primary">Liste des auteurs secondaires</a>
          </div>
          ...
          <div class="col-md-12 col-lg-8 offset-lg-2 bd-example">
              ...
              <form action="">
                  ...
                  <div class="mb-3 row">
                      ...
                      <div class="col-sm-7">
                          <input type="text" class="form-control" id="cnom-auteur" name="nom-auteur"
                  ...
                  <div class="mb-3 row">
                      ...
                      <div class="col-sm-7">
                          <input type="text" class="form-control" id="prenom-auteur" name="prenom-auteur"
