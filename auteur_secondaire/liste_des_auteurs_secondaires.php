...
<head>
  ...
  <title>Liste des auteurs secondaires</title>
...
<main id="main" class="main">
    <div class="row">
        ...
        <div class="col-md-6 text-end bibliothèque-list-add-btn">
            <a href="ajouter_auteur_secondaire.php" class="btn btn-primary">Ajouter un auteur secondaire</a>
        </div>
        </div>
    </div>
  <div class="row mt-5">
        ...
        <tbody>
            <tr>
                ...
                <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                    ...
                    <a href="modifier_auteur_secondaire.php" class="btn btn-warning mb-3">Modifier</a>
