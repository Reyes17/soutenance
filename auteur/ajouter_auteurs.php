    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="auteurs-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="liste_des_auteurs.php">
              <i class="bi bi-circle"></i><span>Liste de auteurs</span>
            </a>
          </li>
          <li>
    ...
    <main id="main" class="main">
        <div class="row">
            ...
            <div class="col-md-6 text-end cefp-list-add-btn">
                <a href="liste_des_auteurs.php" class="btn btn-primary">Liste des auteurs</a>
            </div>
