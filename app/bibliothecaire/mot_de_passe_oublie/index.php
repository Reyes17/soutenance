            ...
            <div class=" col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    <h5 class="card-title text-center pb-0 fs-4">Aviez-vous oublier votre mot de passe?</h5>
                    <p class="text-center small">Veuillez entrer votre compte email afin de recevoir un message</p>
                  </div>
