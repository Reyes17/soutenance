		...
		<main id="main" class="main">
			<div class="row">
				...
				<div class="col-md-6 text-end bibliotheque-list-add-btn">
					<a href="liste_des_ouvrages.php" class="btn btn-primary">Liste des ouvrages</a>
				</div>
			</div>
				...
				<div class="col-md-12 col-lg-8 offset-lg-2 bd-example">
					...
					<form action="">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="code-ouvrage" name="code-ouvrage" placeholder="Veuillez entrer le code de l'ouvrage">
							</div>
						</div>
						<div class="mb-3 row">
						...
						<div class="mb-3 row">
							<label for="nombre-exemplaire-ouvrage" class="col-sm-2 col-form-label">Nombre
								d'exemplaire:</label>
							<div class="col-sm-10">
								<input type="text" class="form-control" id="nombre-exemplaire-ouvrage" name="nombre-exemplaire-ouvrage" placeholder="Veuillez entrer le nombre d'exemplaire de l'ouvrage">
							</div>
						</div>
						<div class="mb-3 row">
							...
							<div class="col-sm-7">
								<select class="form-select js-example-basic-single" id="auteur-principal-ouvrage" name="auteur-principal-ouvrage">
