							...
							<div class="card-body">
								...
								<form class="row needs-validation" action="<?= PROJECT_DIR; ?>bibliothecaire/reinitialiser_mot_passe/traitement" method="post">
									...
									<div class="col-12 mt-3">
										...
										<input type="password" id="reinitialiser_mot_de_passe" class="form-control <?= isset($_SESSION['errors']['mot_de_passe']) ? 'is-invalid' : '' ?>" name="mot_de_passe" placeholder=" Veuillez entrer un mot de passe" value="">
