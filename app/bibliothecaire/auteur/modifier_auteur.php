	...
	<main id="main" class="main">
		...
		<div class="row mt-5 ">
			...
			<div class="col-md-12 col-lg-8 offset-lg-2 bd-example">
				...
				<form action="<?= PROJECT_DIR; ?>bibliothecaire/auteur/modifier_auteur_traitement" method="post">
					...
					<div class="mb-3 row">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control <?= isset($_SESSION['modification_errors']['prenom_aut']) ? 'is-invalid' : '' ?>" id="prenom-auteur" name="prenom_aut" value="<?= isset($prenom_aut) ? $prenom_aut : '' ?><?= isset($_SESSION['prenom_aut']) ? $_SESSION['prenom_aut'] : '' ?>">
							<?php
								unset($_SESSION['prenom_aut']);
								?>
							<?php
							if (isset($_SESSION['modification_errors']['prenom_aut'])) {
							?>
								<div class="invalid-feedback">
									<?= $_SESSION['modification_errors']['prenom_aut'] ?>
								</div>
							<?php
							}
							?>
