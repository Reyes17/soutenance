                ...
                <div class="card-body">
                  ...
                  <div class="col-12 mt-3">
                        ...
                        <div class="input-group has-validation">
                          ...
                          <input type="text"  class="form-control <?= isset($_SESSION['errors']['nom_utilisateur']) ? 'is-invalid' : ''?>" name="nom_utilisateur" id="nom_utilisateur" value="<?php if (isset($data["nom_utilisateur"]) && !empty($data["nom_utilisateur"])) {echo $data["nom_utilisateur"]; } elseif(isset($users_utilisateur)){echo $users_utilisateur; unset ($_SESSION['data']);} else{ echo '';}?>"
