                            ...
                            <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><div class="btn btn-warning">Emprunter</div> <div class="btn btn-success">Rendu</div></td>
                                        <td>    
                                    ...
                                    <tr>
                                        <td>A102</td>
                                        <td>Anastasie</td>                        
                                        <td><button type="" class="btn btn-success">Rendu</button></td>
                                        <td>
                                        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                 data-bs-target="#cefp-ouvrage-modifier">Voir les détails</a>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td><button type="" class="btn btn-warning">Emprunter</button></td>
                                        <td>
                                        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                 data-bs-target="#cefp-ouvrage-modifier">Voir les détails</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>B101</td> 
                                        <td>A101</td>                          
                                        <td><div class="btn btn-success">Rendu</div></td>
                                        <td>
                                        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                 data-bs-target="#cefp-ouvrage-modifier">Voir les détails</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>B102</td> 
                                        <td>Tom Soyer</td>                          
                                        <td><button type="submit" class="btn btn-success">Rendu</button></td>
                                        <td>
                                        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                 data-bs-target="#cefp-ouvrage-modifier">Voir les détails</a>
                                        </td>
                                    ...
                                    <tr>
                                        <td>B103</td>
                                        <td>Avengers</td>
                                        <td><button type="submit" class="btn btn-warning">Emprunter</button></td>
                                        <td>
                                        <a href="#" class="btn btn-primary mb-3" data-bs-toggle="modal"
                                                 data-bs-target="#cefp-ouvrage-modifier">Voir les détails</a>
                                        </td>
