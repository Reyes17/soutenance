			...
			<div class="col-xl-4">
				...
				<div class="card">
					...
					<div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
						...
						<img
							src="<?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['avatar'] : 'avatar' ?>"
						...
						<div class="tab-content">
							...
							<div class="profile-overview">
								...
								<div class="row">
									...
									<div
										class="col-lg-9 col-md-8"> <?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['nom'] : 'Nom' ?> <?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['prenom'] : 'Prenom' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Sexe</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['sexe'] : 'sexe' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Nom d'utilisateur</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['nom_utilisateur'] : 'nom_utilisateur' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Date de naissance</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['date_naissance'] : 'date_naissance' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Adresse</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['adresse'] : 'adresse' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Téléphone</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['telephone'] : 'telephone' ?></div>
								</div>

								<div class="row">
									<div class="col-lg-3 col-md-4 label">Email</div>
									<div
										class="col-lg-9 col-md-8"><?= isset($_SESSION['utilisateur_connecter']) ? $_SESSION['utilisateur_connecter'][0]['email'] : 'email' ?></div>
								</div>
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<input name="nom" type="text" class="form-control" id="fullName"
												   value="<?= $_SESSION["utilisateur_connecter"][0]['nom'] ?>">
										</div>
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<input name="prenom" type="text" class="form-control" id="fullname"
												   value="<?= $_SESSION["utilisateur_connecter"][0]['prenom'] ?>">
										</div>
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<input name="adresse" type="text" class="form-control" id="adresse"
												   ...
												   value="<?= $_SESSION["utilisateur_connecter"][0]['adresse'] ?>">
										</div>
									</div>

									<div class="row mb-3">
										<label for="nom_utilisateur" class="col-md-4 col-lg-3 col-form-label">Nom
											d'utilisateur</label>
										<div class="col-md-8 col-lg-9">
											<input name="nom_utilisateur" type="text" class="form-control"
												   id="nom_utilisateur"
												   value="<?= $_SESSION["utilisateur_connecter"][0]['nom_utilisateur'] ?> ">
										</div>
									</div>
									...
									<div class="row mb-3">
										...
										<div class="col-md-8 col-lg-9">
											<input name="telephone" type="text" class="form-control" id="telephone"
												   ...
												   value="<?= $_SESSION["utilisateur_connecter"][0]['telephone'] ?>">
										</div>
									</div>

									<div class="row mb-3">
										<label for="traitement_mot_de_passe" class="col-md-4 col-lg-3 col-form-label">Mot
											de passe</label>
										<div class="col-md-8 col-lg-9">
											<input type="password"
												   class="form-control <?= isset($_SESSION['errors']['mot_de_passe']) ?: '' ?>"
												   name="mot_de_passe"
