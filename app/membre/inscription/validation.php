...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <section class="section">
   <main id="main">
      <div class="row">
        <h3> Merci de vous êtes inscrit sur le site de notre bibliothèque.<br/>
         Veuillez maintenant consulter votre boîte E-mail un message vous a été envoyé afin de valider votre inscription
        Cordialement.
        </h3>
         </div>  
    </main>    
