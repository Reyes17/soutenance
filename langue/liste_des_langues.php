   ...
   <main id="main" class="main">
      <div class="row">
        ...
        <div class="col-md-6 text-end bibliotheque-list-add-btn">
            <a href="ajouter_langue.php" class="btn btn-primary">Ajouter une langue</a>
        </div>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <a href="modifier_langue.php" class="btn btn-warning mb-3">Modifier</a>
